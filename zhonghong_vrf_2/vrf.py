...
def setConfig():
    global CONFIG
    CONFIG = {}
    CONFIG['broker'] = "192.168.2.117"
    CONFIG['port'] = 1883
    CONFIG['gateway'] = "192.168.2.227"
    CONFIG['username'] = ""
    CONFIG['password'] = ""
...
def initializeClimates(client, node_id = "zhonghong2", component = "climate", discovery_prefix = "homeassistant"):
    global acs
    acs = getACList()
    for ac in acs:
...
def removeClimate(object_id, node_id = "zhonghong2", component = "climate", discovery_prefix = "homeassistant"):
    topic = "{0}/{1}/{2}/{3}/config".format(discovery_prefix, component, node_id, object_id)
    publish(client, topic, json.dumps(''))

def syncACList(client, node_id = "zhonghong2", component = "climate", discovery_prefix = "homeassistant"):
    global STATES, acs
    acs_temp = getACList()
